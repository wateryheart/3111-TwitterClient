package hk.ust.cse.TwitterClient.DM;
...
public class DirectMessageHistory extends RowComposite {	
	
	public DirectMessageHistory (Composite parentView, User user, int width ,int height, Object handlerCallee) {
	    ...
	    addDisposeListener(new DisposeListener() {
	      public void widgetDisposed(DisposeEvent e) {
	    	  DirectMessageHistory.this.widgetDisposed(e);
	      }
	    });
	}
