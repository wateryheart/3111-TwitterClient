...
public class UtilsTest {
  ...
  public void testDarkGradually() throws Throwable {
	...
	Image expected1 = new Image(display, actual1.getImageData());
	
	assertEquals(expected1.getBackground(), Utils.darkGradually(actual1,0).getBackground());
	assertEquals(expected1.getBounds(), Utils.darkGradually(actual1,0).getBounds());
