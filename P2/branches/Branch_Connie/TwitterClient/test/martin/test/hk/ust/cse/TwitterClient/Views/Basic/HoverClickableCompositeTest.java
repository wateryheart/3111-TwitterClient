...
public class HoverClickableCompositeTest {
	 @Test(timeout=10000)
	  public void testConstructor() throws Throwable {
	    ...
	    HoverClickableComposite composite = new HoverClickableComposite(shell, null, null, null);
	   
	    assertFalse(composite.isClicked());
	    
	    // --
	    MouseTrackListener mouseTrackListener = TestUtils.getListener(composite, SWT.MouseHover, "HoverClickableComposite");
