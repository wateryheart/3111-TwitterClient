...
public class LinkLabelTest {
  ...
  public void testConstructor() throws Throwable {
    ...
    LinkLabel linkLabel = new LinkLabel(shell,0,Resources.MINI_PROFILE_COLOR, Resources.WHITE_COLOR, Resources.FONT11, Resources.FONT11B);
    assertNotNull(linkLabel);

    Event event1 = new Event();
	event1.widget = linkLabel;
	MouseEvent e1 = new MouseEvent(event1);
	Listener[] listen1 = linkLabel.getListeners(SWT.MouseHover);
	SWTEventListener listener1 = ((TypedListener) (listen1[0])).getEventListener();
	((MouseTrackListener)listener1).mouseHover(e1);
	
	Listener[] listen2 = linkLabel.getListeners(SWT.MouseExit);
	SWTEventListener listener2 = ((TypedListener) (listen2[0])).getEventListener();
	((MouseTrackListener)listener2).mouseExit(e1);
	
	Listener[] listen3 = linkLabel.getListeners(SWT.MouseEnter);
