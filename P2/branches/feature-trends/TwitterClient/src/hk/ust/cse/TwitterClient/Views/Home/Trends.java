...
public class Trends extends ClickableComposite {
  
  public Trends(Composite parentView, User user, int width, int height) {
    super(parentView);
    ...
    addMouseTrackListener(new MouseTrackListener() {
      ...
      public void mouseExit(MouseEvent arg0) {
        Rectangle rect = Trends.this.getClientArea();
  ...
  private void initialize(int width, int height) {
    ...
    // set name
    m_name1 = new Label(nameFrame, 0);
    m_name1.setFont(Resources.FONT11);
    m_name1.setForeground(Resources.TEXT_COLOR);
    m_name1.setText("1");
    
    m_name2 = new Label(nameFrame, 0);
    m_name2.setFont(Resources.FONT11);
    m_name2.setForeground(Resources.TEXT_COLOR);
    m_name2.setText("2");
...
//    Utils.cutRoundCorner(m_icon, true, true, true, true);
  ...
  private Label m_name1;
  private Label m_name2;
