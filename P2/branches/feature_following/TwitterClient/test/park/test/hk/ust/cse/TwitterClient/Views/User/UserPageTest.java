...
public class UserPageTest {
  ...
  public void testConstructor() throws Throwable {
    ...
    UserPage userPage1 = new UserPage(shell, statuses.get(0).getUser(), "test", 100, 10, 10, 10, 10, 10, null, null);
    UserPage userPage2 = new UserPage(shell, friend, "Tweets", 100, 2000, 10, 10, 10, 10, null, null);
    ...
    UserMenu uMenuTest = getPrivateUserMenu(userPage1);
	...
	userPage1.showTweetsList(statuses);
	userPage2.showTweetsList(statuses);
	...
	assertEquals(statuses.get(0).getUser(), userPage1.getUser());
