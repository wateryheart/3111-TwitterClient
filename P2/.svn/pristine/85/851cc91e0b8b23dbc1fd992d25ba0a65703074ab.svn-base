...
public class TweetViewControlTest {
	...
	public void testTweetViewControl() throws Throwable{
	    ...
	    TweetView tweetView = new TweetView(shell, status, 10, true, Resources.SPLIT_COLOR, Resources.SPLIT_COLOR, Resources.SPLIT_COLOR, "name", null);
	    TweetViewControl TC = new TweetViewControl(null);
		assertNotNull(TC);
