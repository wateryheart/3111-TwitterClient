...
public class TwitterClient {
  ...
  public TwitterClient(final int width, final int height) throws TwitterException {
    ...
    Logger logger = Logger.getLogger("styleTweet");
    Logger mutexLogger = Logger.getLogger("mutex");
    Logger searchLogger = Logger.getLogger("search");
    if(!"true".equals(System.getProperty("debug"))){
        logger.setLevel(Level.OFF);
        mutexLogger.setLevel(Level.OFF);
        searchLogger.setLevel(Level.OFF);
    }
    ...
    if (Resources.APP_ICON!=null)
        shell.setImage(Resources.APP_ICON);
    Display.setAppName("TwiApp");
    shell.open();
