    ...
    public void ApplyChange() {
        ...
        for (ITextFeature tweetFeature : features) {
            ...
            if(data != null){
                ...
                //System.out.println( String.format("entities size: %d", entities.length) );
            }
        }
        ...
        for (Pair<Entity, ITextStyle> p : entitySortedMap.values()) {
            ...
            System.out.println(String.format("key => start: %d length: %d text: %s ", e.Start, e.Length, e.Text));
        ...
        //call one time to set all text styles to the view
            ...
            System.out.println("set style interrupted.");
        }
