...
public class TwitterClient {
  ...
  public TwitterClient(final int width, final int height) throws TwitterException {
    ...
    // disable all console loggers when debug flag isn't set to true
    if(!"true".equals(System.getProperty("debug"))){
         LogManager.removeAppender( new String []{"org.apache.log4j.ConsoleAppender"});
     }

    // turn off twitter4j internal loggers
