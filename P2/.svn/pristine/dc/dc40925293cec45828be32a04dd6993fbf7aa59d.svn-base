...
public class UserPage extends RowComposite {
  ...
  public void showTweetsList(List<Status> tweets) {
    System.out.println("UserPage showTweetsList");

      if(isDisposed()){
          Mutex.releaseUserPageMutex();
          System.out.println("releaseUserPageMutex because UserPage is disposed.");
    ...
    Mutex.releaseUserPageMutex();
    System.out.println("releaseUserPageMutex");
  }
